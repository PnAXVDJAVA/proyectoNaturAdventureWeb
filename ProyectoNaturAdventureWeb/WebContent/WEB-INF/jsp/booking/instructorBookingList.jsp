...
<jsp:body>
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<c:forEach items="${instructorBookings}" var="booking">
				
					<tr>
						<td>${booking.proposalPerformingDateString}</td>
	                	<td><a href="${pageContext.request.contextPath}/customer/customerInstructorDetails/${booking.customerNif}.html">${booking.customerName}</a></td>
	                	<td><a href="${pageContext.request.contextPath}/activity/activityCustomerDetails/${booking.codActivity}.html">${booking.activityName}</a></td>
	                	<td><a href="${pageContext.request.contextPath}/booking/instructorBookingDetails.html?instructorNif=${profile.nif}&codBooking=${booking.codBooking}"><span class="glyphicon glyphicon-info-sign"></span>  Más detalles</a></td>	                	
					</tr>
		...
		<script type="text/javascript">
			...
			function buscar() {
				...
				location.href = '${pageContext.request.contextPath}/booking/instructorBookingListSearch.html?nif=${profile.nif}&criterioBusqueda=' + criterio + '&valor=' + valor;
			}

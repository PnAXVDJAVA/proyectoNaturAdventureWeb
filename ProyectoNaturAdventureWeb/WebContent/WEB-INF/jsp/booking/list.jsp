...
<jsp:body>
			...
			<table class="table table-striped">
				...
				<c:set var="status" scope="request" value='${booking.status}'/>
					...
					<tr>
	                	...
	                	<td><a href="${pageContext.request.contextPath}/customer/customerDetails/${booking.customerNif}.html">${booking.customerName}</a></td>
		...
		<script type="text/javascript">
			...
			function buscar() {
				...
				location.href = '${pageContext.request.contextPath}/booking/listSearch.html?criterioBusqueda=' + criterio + '&valor=' + valor;
			}
